          ...
          {isOrdered ? (
            <div className="text-center py-16 space-y-6">
              ...
              <button
                ...
                className="px-8 py-3.5 rounded-full bg-slate-950 text-white font-extrabold text-xs shadow-lg hover:bg-slate-800 transition-all"
              >
            ...
            <div>
              ...
              <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-6">
                <div className="flex items-center gap-3">
                  <span className="font-display text-xl font-extrabold text-slate-950">
                    L'ÉROSE PARIS
                  </span>
                  <span className="text-[10px] uppercase font-bold px-2.5 py-0.5 rounded bg-slate-100 border border-slate-300 text-slate-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                <div className="md:col-span-6">
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 h-96">
                    ...
                    />
                    <div className="absolute top-4 left-4 rounded-full bg-white/90 px-3 py-1 text-xs font-bold text-slate-950 backdrop-blur-md border border-slate-200">
                      ✦ Autumn Collection
                    </div>
                  </div>
                </div>
                ...
                <div className="md:col-span-6 space-y-6">
                  <div>
                    ...
                    <div className="mt-2 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 text-xs">
                        ...
                        <span className="font-bold text-slate-950">4.9</span> (128 Reviews)
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 p-4 rounded-2xl border border-slate-200 bg-slate-50">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-bold text-slate-950">Size {selectedSize}</span>
                    </div>
                    ...
                    <div className="pt-2 border-t border-slate-200">
                      <p className="text-[11px] font-bold text-slate-950 flex items-center gap-1.5 mb-2">
                        <Sparkles className="w-3.5 h-3.5 text-amber-500" /> {lang === 'VI' ? 'Tính Toán Size AI Precision:' : 'AI Sizing Precision Calculator:'}
                      </p>
                      <form onSubmit={handleCalcAiSize} className="flex gap-2">
                        ...
                        <button
                          type="submit"
                          className="px-3 py-1.5 rounded-lg bg-slate-950 text-white font-bold text-xs hover:bg-slate-800 whitespace-nowrap"
                        >
                      ...
                      {aiFitResult && (
                        <motion.div
                          ...
                          className="mt-2 p-2.5 rounded-lg bg-white border border-slate-200 text-[11px] text-slate-900"
                        >
                          <p className="font-bold text-slate-950">
                            {lang === 'VI' ? 'Khuyên dùng:' : 'Recommended:'} Size {aiFitResult.size} ({aiFitResult.confidence})
                          </p>
                          <p className="mt-0.5 text-slate-600 font-medium">{aiFitResult.note}</p>
                        </motion.div>
                      )}
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-2xl bg-slate-950 text-white font-black text-xs shadow-xl hover:bg-slate-800 transition-all flex items-center justify-center gap-2"
                  >
