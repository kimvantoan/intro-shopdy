  ...
  const PLANS = [
    {
      ...
      features: lang === 'VI' ? [
        ...
        'AI Size Matcher Standard (Giảm trả hàng)',
        'Quản lý tới 5,000 SKU biến thể Size/Màu',
        'Băng thông kháng tải 100GB / tháng',
        'Tích hợp Stripe, Apple Pay, VietQR, COD',
        'Đồng bộ 1 kênh mạng xã hội POS (IG/FB)',
      ] : [
        '1 Storefront Visual Studio License (4K)',
        'Standard AI Fit Matcher (Cuts return rates)',
        'Manage up to 5,000 Variant SKUs',
        '100GB / Month Bandwidth Surge Included',
        'Integrated Stripe, Apple Pay & VietQR',
        'Single Social Channel POS Sync (IG/FB)',
      ],
    ...
    },
    {
      ...
      features: lang === 'VI' ? [
        ...
        'Pro AI Fit Matcher (Gợi ý form chuẩn 98.4%)',
        '3D Lookbook Studio & Outfit Configurator',
        'Đồng bộ Realtime TikTok Shop & 5 Showroom POS',
        'Hạ tầng Flash Sale chịu tải 100,000 RPM',
        'Tự động tạo mã QR Code Anti-Counterfeit',
        'Báo cáo Phân Tích Doanh Thu & Form Dáng AI',
      ] : [
        'Everything in Boutique Store OS',
        'Pro AI Fit Matcher (98.4% Precision Fit)',
        '3D Lookbook Studio & Outfit Configurator',
        'Realtime Sync for TikTok Shop & 5 Boutique POS',
        '100,000 RPM Flash Sale Capacity Infrastructure',
        'Automated QR Code Anti-Counterfeit Tagging',
        'AI Sizing & Fit Analytics Reporting',
      ],
    ...
    },
    {
      ...
      features: lang === 'VI' ? [
        ...
        'Không giới hạn Showroom POS & Kênh Bán',
        'Tích hợp Hệ thống ERP (SAP, Salesforce, KiotViet)',
        'Tùy biến Giao diện Haute Couture độc bản',
        ...
        'Unlimited POS Showrooms & Sales Channels',
        'Custom ERP Integrations (SAP, Salesforce, KiotViet)',
        'Bespoke Haute Couture Custom Theme Studio',
        'Dedicated VIP Account Manager & 24/7 Tech Lead',
        '99.99% Uptime Guarantee SLA',
      ],
      cta: lang === 'VI' ? 'Liên Hệ Đội Ngu Enterprise' : 'Contact Enterprise Team',
    },
  ];
